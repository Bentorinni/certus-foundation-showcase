          ...
          <AnimatedSection direction="left">
            <div className="flex flex-col h-full">
              <form onSubmit={handleSubmit} className="space-y-6 flex-1">
                ...
                <button
                  type="submit"
                  className="group w-full bg-gradient-gold text-accent-foreground py-4 rounded-lg font-semibold text-sm tracking-wide uppercase flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-[0_0_30px_hsl(145_100%_45%/0.3)] hover:scale-[1.01] font-body"
                >

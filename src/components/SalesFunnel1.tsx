          ...
          <div className="space-y-5">
            {steps.map((step, i) => (
              <AnimatedSection key={i} delay={i * 0.2} direction="right">
                <div className="<div className="group relative flex items-center gap-5 glass rounded-xl p-6 transition-all duration-500 md:hover:border-accent/40 md:hover:shadow-[0_0_30px_hsl(142_100%_50%/0.1)]"> className="group relative flex items-center gap-5 glass rounded-xl p-6 transition-all duration-500 md:hover:border-accent/40 md:hover:shadow-[0_0_30px_hsl(142_100%_50%/0.1)]">
                  {/* Left neon bar */}
